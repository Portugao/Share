...
abstract class AbstractMessageFormAwareHookSubscriber implements HookSubscriberInterface
{
    ...
    public function getEvents()
    {
        return [
            ...
            FormAwareCategory::TYPE_EDIT => 'musharemodule.form_aware_hook.messages.edit',
            // Process the results of the edit form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_EDIT => 'musharemodule.form_aware_hook.messages.process_edit',
            // Display hook for delete forms.
            FormAwareCategory::TYPE_DELETE => 'musharemodule.form_aware_hook.messages.delete',
            // Process the results of the delete form after the main form is processed.
            FormAwareCategory::TYPE_PROCESS_DELETE => 'musharemodule.form_aware_hook.messages.process_delete'
        ];
    }
}
