...
namespace MU\ShareModule\Block\Base;

use Zikula\BlocksModule\AbstractBlockHandler;
use Zikula\Core\AbstractBundle;
use MU\ShareModule\Helper\FeatureActivationHelper;
use MU\ShareModule\Block\Form\Type\ItemListBlockType;
...
abstract class AbstractItemListBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('MUShareModule:ItemListBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        if (in_array($objectType, $this->categorisableObjectTypes)) {
            if ($featureActivationHelper->isEnabled(FeatureActivationHelper::CATEGORIES, $properties['objectType'])) {
                $categoryHelper = $this->get('mu_share_module.category_helper');
        ...
        if (empty($properties['title'])) {
            $properties['title'] = $this->__('MUShareModule items');
        }
        ...
        $templateParameters = $this->get('mu_share_module.controller_helper')->addTemplateParameters($properties['objectType'], $templateParameters, 'block', []);
    ...
    public function getFormOptions()
    {
        ...
        return [
            ...
            'category_helper' => $this->get('mu_share_module.category_helper'),
            'feature_activation_helper' => $this->get('mu_share_module.feature_activation_helper')
        ];
    }
    ...
    {
        return '@MUShareModule/Block/itemlist_modify.html.twig';
    }
