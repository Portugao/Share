...
use MU\ShareModule\Block\Form\Type\ItemBlockType;
...
abstract class AbstractItemBlock extends AbstractBlockHandler
{
    ...
    public function display(array $properties)
    {
        ...
        if (!$this->hasPermission('MUShareModule:ItemBlock:', "$properties[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
        ...
        $controllerReference = new ControllerReference('MUShareModule:External:display', $this->getDisplayArguments($properties), ['template' => $properties['customTemplate']]);
    ...
    {
        return '@MUShareModule/Block/item_modify.html.twig';
    }
