...
namespace MU\ShareModule\Form\Plugin\Base;
...
class AbstractItemSelector extends Zikula_Form_Plugin_TextInput implements ContainerAwareInterface
{
    ...
    public function render(Zikula_Form_View $view)
    {
        ...
        if ($firstTime) {
            ...
            $jsAssetBag->add($assetHelper->resolve('@MUShareModule:js/MUShareModule.js'));
            $jsAssetBag->add($assetHelper->resolve('@MUShareModule:js/MUShareModule.ItemSelector.js'));
        ...
        if (!$permissionApi->hasPermission('MUShareModule:' . ucfirst($this->objectType) . ':', '::', ACCESS_COMMENT)) {
            return false;
        }

        $categorisableObjectTypes = ['offer'];
        $catIds = [];
        ...
        $view = Zikula_View::getInstance('MUShareModule', false);
    ...
    public function decode(Zikula_Form_View $view)
    {
        ...
        $this->objectType = $request->request->get('MUShareModule_objecttype', 'location');
