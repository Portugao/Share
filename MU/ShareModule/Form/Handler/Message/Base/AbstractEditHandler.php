...
namespace MU\ShareModule\Form\Handler\Message\Base;

use MU\ShareModule\Form\Handler\Common\EditHandler;
use MU\ShareModule\Form\Type\MessageType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUShareModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'message', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
