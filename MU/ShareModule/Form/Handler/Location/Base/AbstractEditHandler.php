...
namespace MU\ShareModule\Form\Handler\Location\Base;

use MU\ShareModule\Form\Handler\Common\EditHandler;
use MU\ShareModule\Form\Type\LocationType;
...
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        $this->objectTypeCapital = 'Location';
        $this->objectTypeLower = 'location';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the location yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create(LocationType::class, $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of location area
        $codes[] = 'userIndex';
        // admin index page of location area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated location
        $codes[] = 'userDisplay';
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    ...
                    $message = $this->__('Done! Location updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Location deleted.');
                break;
            default:
                $message = $this->__('Done! Location updated.');
                break;
