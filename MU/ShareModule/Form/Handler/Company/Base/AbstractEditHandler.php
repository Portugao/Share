...
namespace MU\ShareModule\Form\Handler\Company\Base;

use MU\ShareModule\Form\Handler\Common\EditHandler;
use MU\ShareModule\Form\Type\CompanyType;
 ...
 * It aims on the company object type.
 */
abstract class AbstractEditHandler extends EditHandler
{
    ...
    public function processForm(array $templateParameters)
    {
        ...
        $this->objectTypeCapital = 'Company';
        $this->objectTypeLower = 'company';
        ...
        if ($this->templateParameters['mode'] == 'create') {
            if (!$this->modelHelper->canBeCreated($this->objectType)) {
                $this->request->getSession()->getFlashBag()->add('error', $this->__('Sorry, but you can not create the company yet as other items are required which must be created before!'));
    ...
    protected function createForm()
    {
        ...
        return $this->formFactory->create(CompanyType::class, $this->entityRef, $options);
    }
    ...
    protected function getRedirectCodes()
    {
        ...
        // user index page of company area
        $codes[] = 'userIndex';
        // admin index page of company area
        $codes[] = 'adminIndex';
        ...
        $codes[] = 'adminOwnView';
        // user detail page of treated company
        $codes[] = 'userDisplay';
        // admin detail page of treated company
        $codes[] = 'adminDisplay';
    ...
    protected function getDefaultMessage(array $args = [], $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                if ($this->templateParameters['mode'] == 'create') {
                    $message = $this->__('Done! Company created.');
                } else {
                    $message = $this->__('Done! Company updated.');
                }
                break;
            case 'delete':
                $message = $this->__('Done! Company deleted.');
                break;
            default:
                $message = $this->__('Done! Company updated.');
                break;
    ...
    public function applyAction(array $args = [])
    {
        ...
        try {
            ...
            $logArgs = ['app' => 'MUShareModule', 'user' => $this->currentUserApi->get('uname'), 'entity' => 'company', 'id' => $entity->getKey(), 'errorMessage' => $exception->getMessage()];
