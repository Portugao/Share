...
/**
 * Pool quick navigation form type base class.
 */
abstract class AbstractPoolQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    {
        $listEntries = $this->listHelper->getEntries('pool', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'musharemodule_poolquicknav';
    }
}
