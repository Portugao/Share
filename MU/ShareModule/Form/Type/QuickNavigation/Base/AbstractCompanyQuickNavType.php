...
/**
 * Company quick navigation form type base class.
 */
abstract class AbstractCompanyQuickNavType extends AbstractType
{
    use TranslatorTrait;
    ...
    /**
     * CompanyQuickNavType constructor.
     *
    ...
    {
        $listEntries = $this->listHelper->getEntries('company', 'workflowState');
        $choices = [];
        $choiceAttributes = [];
    ...
    {
        return 'musharemodule_companyquicknav';
    }
}
