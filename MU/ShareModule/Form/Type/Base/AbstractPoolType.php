...
/**
 * Pool editing form type base class.
 */
abstract class AbstractPoolType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addEntityFields(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('collectionOfPool', TextType::class, [
            'label' => $this->__('Collection of pool') . ':',
            'empty_data' => 'collection',
            'attr' => [
                'maxlength' => 255,
                'class' => '',
                'title' => $this->__('Enter the collection of pool of the pool')
            ],
            'required' => true,
        ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver
            ->setDefaults([
                ...
                'data_class' => 'MU\ShareModule\Entity\PoolEntity',
                'empty_data' => function (FormInterface $form) {
                    return $this->entityFactory->createPool();
                },
                'error_mapping' => [
                ],
                'mode' => 'create',
