...
namespace MU\ShareModule\Form\Type\Finder\Base;
...
/**
 * Company finder form type base class.
 */
abstract class AbstractCompanyFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the company') => 1,
                $this->__('Absolute url to the company') => 2,
                $this->__('ID of company') => 3
            ],
    ...
    {
        return 'musharemodule_companyfinder';
    }
