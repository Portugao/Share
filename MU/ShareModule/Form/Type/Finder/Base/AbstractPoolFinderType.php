...
/**
 * Pool finder form type base class.
 */
abstract class AbstractPoolFinderType extends AbstractType
{
    use TranslatorTrait;
    ...
    public function addPasteAsField(FormBuilderInterface $builder, array $options)
    {
        $builder->add('pasteAs', ChoiceType::class, [
            ...
            'empty_data' => 1,
            'choices' => [
                $this->__('Relative link to the pool') => 1,
                $this->__('Absolute url to the pool') => 2,
                $this->__('ID of pool') => 3
            ],
    ...
    public function addSortingFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('sort', ChoiceType::class, [
                ...
                'empty_data' => '',
                'choices' => [
                    $this->__('Collection of pool') => 'collectionOfPool',
    ...
    {
        return 'musharemodule_poolfinder';
    }
