...
abstract class AbstractKernelListener implements EventSubscriberInterface
{
     ...
     *     `$testMessage = 'Hello from share app';
     *     $event->getRequest()->attributes->set('MUShareModule_test', $testMessage);`
     *
     ...
     *     `$testMessage = $event->getRequest()->attributes->get('MUShareModule_test');`
     *     now `$testMessage` should be: `'Hello from share app'`
     *
     ...
     *         $response = new Response();
     *         $message = sprintf('share App Error says: %s with code: %s', $exception->getMessage(), $exception->getCode());
