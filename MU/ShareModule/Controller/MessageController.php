...
use MU\ShareModule\Controller\Base\AbstractMessageController;
...
class MessageController extends AbstractMessageController
{
     ...
     * @inheritDoc
     *
     * @Route("/admin/message/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html|xml|json|kml"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET"}
     * )
     * @ParamConverter("message", class="MUShareModule:MessageEntity", options = {"repository_method" = "selectById", "mapping": {"id": "id"}, "map_method_signature" = true})
     * @Theme("admin")
     *
     * @param Request $request Current request instance
     ...
     * @inheritDoc
     *
     * @Route("/admin/message/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
     ...
     * @inheritDoc
     *
     * @Route("/message/delete/{id}.{_format}",
     *        requirements = {"id" = "\d+", "_format" = "html"},
     *        defaults = {"_format" = "html"},
     *        methods = {"GET", "POST"}
     * )
