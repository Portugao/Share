...
abstract class AbstractControllerHelper
{
    ...
    /**
     * Returns an array of all allowed object types in MUShareModule.
     *
    ...
    /**
     * Returns the default object type in MUShareModule.
     *
     * @param string $context Usage context (allowed values: controllerAction, api, helper, actionHandler, block, contentType, util)
     * @param array  $args    Additional arguments
     *
    ...
    public function performGeoCoding($address)
    {
        ...
        //require_once('modules/MU/ShareModule/vendor/Snoopy/Snoopy.class.php');
        //$snoopy = new Snoopy();
        //$snoopy->fetch($url);
        //$json = $snoopy->results;
        ...
        if (json_last_error() == JSON_ERROR_NONE && $data->status == 'OK' && count($data) > 0) {
            ...
            $logArgs = ['app' => 'MUShareModule', 'user' => $this->currentUserApi->get('uname'), 'field' => $field, 'address' => $address];
