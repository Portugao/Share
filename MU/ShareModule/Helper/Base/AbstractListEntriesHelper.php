...
abstract class AbstractListEntriesHelper
{
            ...
            case 'offer':
                switch ($fieldName) {
                    case 'workflowState':
                        ...
                        break;
                    case 'period':
                        $entries = $this->getPeriodEntriesForOffer();
                        break;
                }
                break;
            case 'pool':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForPool();
                        break;
                }
                break;
            case 'company':
    ...
    /**
     * Get 'period' list entries.
     *
     * @return array Array with desired list entries
     */
    public function getPeriodEntriesForOffer()
    {
        $states = [];
        $states[] = [
            'value'   => 'daily',
     ...
     * @return array Array with desired list entries
     */
    public function getWorkflowStateEntriesForPool()
    {
        $states = [];
        $states[] = [
            'value'   => 'approved',
