...
abstract class AbstractSearchHelper implements SearchableInterface
{
    ...
    {
        if (!$this->permissionApi->hasPermission('MUShareModule::', '::', ACCESS_READ)) {
            return '';
        }
    ...
    public function getResults(array $words, $searchType = 'AND', $modVars = null)
    {
        ...
        foreach ($searchTypes as $searchTypeCode => $typeInfo) {
            ...
            if (isset($moduleActivationInfo['MUShareModule'])) {
                $moduleActivationInfo = $moduleActivationInfo['MUShareModule'];
            ...
            switch ($objectType) {
                ...
                case 'offer':
                    $whereArray[] = 'tbl.workflowState';
                    $whereArray[] = 'tbl.product';
                    $whereArray[] = 'tbl.description';
                    $whereArray[] = 'tbl.period';
                    $whereArray[] = 'tbl.zipCode';
                    $whereArray[] = 'tbl.meetingPlace';
                    break;
                case 'pool':
                    $whereArray[] = 'tbl.workflowState';
            ...
            foreach ($entities as $entity) {
                ...
                if (!$this->permissionApi->hasPermission('MUShareModule:' . ucfirst($objectType) . ':', $entity->getKey() . '::', ACCESS_OVERVIEW)) {
                    continue;
                }
                ...
                if ($hasDisplayAction) {
                    ...
                    $displayUrl = new RouteUrl('musharemodule_' . strtolower($objectType) . '_display', $urlArgs);
                }
    
                $result = new SearchResultEntity();
                $result->setTitle($formattedTitle)
                    ->setText($description)
                    ->setModule('MUShareModule')
                    ->setCreated($created)
