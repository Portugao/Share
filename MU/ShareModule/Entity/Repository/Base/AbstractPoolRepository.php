 ...
 *
 * This is the base repository class for pool entities.
 */
abstract class AbstractPoolRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\ShareModule\Entity\PoolEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'collectionOfPool';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUShareModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'pools', 'userid' => $userId];
     ...
     *
     * @return array|poolEntity Retrieved data array or poolEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved poolEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('pool', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('pool', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numPools';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('pool', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of pools to exclude (optional)
     *
     * @return boolean Result of this check, true if the given pool does not already exist
     */
    ...
    public function genericBaseQuery($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if (true === $slimMode) {
            ...
            $selection = 'tbl.id';
            $selection .= ', tbl.collectionOfPool';
            $useJoins = false;
        }
