 ...
 *
 * This is the base repository class for location entities.
 */
abstract class AbstractLocationRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\ShareModule\Entity\LocationEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUShareModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'locations', 'userid' => $userId];
     ...
     *
     * @return array|locationEntity Retrieved data array or locationEntity instance
     */
    ...
    {
        $selection = 'COUNT(tbl.id) AS numLocations';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('location', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of locations to exclude (optional)
     *
     * @return boolean Result of this check, true if the given location does not already exist
     */
    ...
    {
        $selection = ', tblCompanyOfLocation, tblPool, tblOfferOfLocation';
