 ...
 *
 * This is the base repository class for offer entities.
 */
abstract class AbstractOfferRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\ShareModule\Entity\OfferEntity';

    /**
     * @var string The default sorting field/expression
     */
    protected $defaultSortingField = 'product';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUShareModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'offers', 'userid' => $userId];
     ...
     *
     * @return array|offerEntity Retrieved data array or offerEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved offerEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('offer', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('offer', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numOffers';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('offer', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of offers to exclude (optional)
     *
     * @return boolean Result of this check, true if the given offer does not already exist
     */
