...
namespace MU\ShareModule\Entity\Repository\Base;
 ...
 *
 * This is the base repository class for company entities.
 */
abstract class AbstractCompanyRepository extends EntityRepository
{
    /**
     * @var string The main entity class
     */
    protected $mainEntityClass = 'MU\ShareModule\Entity\CompanyEntity';
    ...
    public function updateCreator($userId, $newUserId, TranslatorInterface $translator, LoggerInterface $logger, CurrentUserApiInterface $currentUserApi)
    {
        ...
        $logArgs = ['app' => 'MUShareModule', 'user' => $currentUserApi->get('uname'), 'entities' => 'companies', 'userid' => $userId];
     ...
     *
     * @return array|companyEntity Retrieved data array or companyEntity instance
     */
     ...
     * @param boolean $slimMode If activated only some basic fields are selected without using any joins (optional) (default=false)
     *
     * @return ArrayCollection Collection containing retrieved companyEntity instances
     */
    ...
    public function getListQueryBuilder($where = '', $orderBy = '', $useJoins = true, $slimMode = false)
    {
        ...
        if ((!$useJoins || !$slimMode) && null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addCommonViewFilters('company', $qb);
        }
    ...
    public function selectSearch($fragment = '', $exclude = [], $orderBy = '', $currentPage = 1, $resultsPerPage = 25, $useJoins = true)
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->addSearchFilter('company', $qb, $fragment);
        }
    ...
    {
        $selection = 'COUNT(tbl.id) AS numCompanies';
        if (true === $useJoins) {
    ...
    public function selectCount($where = '', $useJoins = false, $parameters = [])
    {
        ...
        if (null !== $this->collectionFilterHelper) {
            $qb = $this->collectionFilterHelper->applyDefaultFilters('company', $qb, $parameters);
        }
     ...
     * @param integer $excludeId  Id of companies to exclude (optional)
     *
     * @return boolean Result of this check, true if the given company does not already exist
     */
    ...
    {
        $selection = ', tblLocationOfCompany';
    ...
    {
        $qb->leftJoin('tbl.locationOfCompany', 'tblLocationOfCompany');
