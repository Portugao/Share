...
function mUShareReadDate(val, includeTime)
{
...
function mUShareValidateNoSpace(val)
{
    var valStr;
 ...
 */
function mUShareExecuteCustomValidationConstraints(objectType, currentEntityId)
{
    jQuery('.validate-nospace').each( function() {
        if (!mUShareValidateNoSpace(jQuery(this).val())) {
